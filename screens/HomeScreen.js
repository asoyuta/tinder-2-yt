...
const HomeScreen = () => {
  ...
  const swipeLeft = (cardIndex) => {
    ...
    console.log(`You swiped PASS on ${userSwiped.googleName}`)
  ...
  const swipeRight = async (cardIndex) => {
    ...
    getDoc(doc(db, 'users', userSwiped.id, 'swipes', user.uid)).then((documentSnapshot) => {
      if (documentSnapshot.exists()) {
        ...
        // Create a MATCH!
        console.log(`Hooray, You MATCHED with ${userSwiped.firstName} ${userSwiped.lastName}`)
        ...
        console.log(`You swiped on ${userSwiped.googleName} (${userSwiped.job})`)
        setDoc(doc(db, 'users', user.uid, 'swipes', userSwiped.id), userSwiped)
      }
    })
  }
